   ...
   <div class="modal-dialog modal-sm"> 
    <div class="modal-content"> 
     <div class="modal-header"> 
      ...
      <h6 class="modal-title" id="mySmallModalLabel"><i class="icon-search align-top bigger-125"></i>&nbsp;查询商品信息 </h6> 
     </div>
     <!--.modal-header  --> 
     <div class="modal-body">
       <form class="form-horizontal" role="form">
          <div class="form-group"> 
             <label class="col-sm-5 control-label no-padding-right font " for="search-name"> 商品名称或简称： </label> 
             <div class="col-sm-6">
  ...
  <script type="text/javascript">
   ...
   jQuery(function($) {
	  ...
	  $("#search-ok").on("click",function(){
		  ...
		  gotoShangPinPage(1,"name="+searchName+"&beginTime="+beginTime+"&endTime="+endTime);
	  });
