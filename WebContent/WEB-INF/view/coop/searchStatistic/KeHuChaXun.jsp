  ...
  <div class="main-container" id="main-container"> 
   ...
   <div class="main-container-inner"> 
    ...
    <div class="main-content"> 
     <div class="breadcrumbs" id="breadcrumbs"> 
      ...
      <ul class="breadcrumb"> 
       ...
       <li><a href="coop/kehuchaxun.html">客户查询</a></li> 
      </ul> 
      <!-- .breadcrumb -->
     </div> 
     <div class="page-content">
      <div class="page-header fixed-div">
        <p><lable>客户名称或简称：</lable><input type="text" id="name"/></p>
        <p>
          <lable>录入时间：</lable>
	...
	function gotoPage(pageIndex, cond) {
		...
		$.ajax({
					url : "coop/pageOfCustomersByName",
					type : 'get',
    ...
    <jsp:include page="/WEB-INF/view/coop/baseManage/KeHuGuanLi_detailed.jsp"></jsp:include>
    <!-- 工具导入 --> 
