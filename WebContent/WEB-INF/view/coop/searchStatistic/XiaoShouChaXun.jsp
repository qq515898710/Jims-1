   ...
   <div class="main-container-inner"> 
    ...
    <div class="main-content"> 
     <div class="breadcrumbs" id="breadcrumbs"> 
      ...
      <ul class="breadcrumb"> 
       ...
       <li><a href="coop/xiaoshouchaxun.html">销售查询</a></li> 
      </ul> 
      <!-- .breadcrumb -->
     </div> 
     ...
     <div class="page-header fixed-div">
        <p>
          <lable>客户名称：</lable><input type="text" id="customername"/>
             ...
             <div id="sample-table-2_wrapper" class="dataTables_wrapper" role="grid">
               <div class="row">
                 <div class="col-sm-6">
                   <div id="pager">
                     <label>显示 
                       <select size="1" onchange="javascript:gotoPage(1,'goodname=&customername=&beginTime=&endTime=')" id="p_pageSizeSelect">
    ...
    jQuery(function($) {
	    $("#search").click(function () {
           ...
           gotoPage(1,"goodname="+goodName+"&customername="+customerName+"&beginTime="+beginTime+"&endTime="+endTime);
	    });
	    
	    $("#search-all").click(function () {
	    	gotoPage(1,'goodname=&customername=&beginTime=&endTime=');
	    });
			...
			success : function(msg) {
				if(msg.totalElement == 0){
					...
					$.each(msg.content, function(i, item) {
						...
						loc+="</ul></div></div>";
						$('#pages').html(loc);
						$("#other").html('<a href="javascript:gotoPage(1,\'goodname=&customername=&beginTime=&endTime=\')" ><i class="icon-refresh"></i></a>&nbsp;|&nbsp;<label >共 '+msg.totalElement+' 记录&nbsp;|&nbsp;共 '+msg.totalPage +' 页</label>');
				}
	...
	function show(id){
		...
		$.ajax({
		    ...
		    success: function (data){
		    	...
		    	$("#detailed-providername").html(data.customerInfo.name);
    ...
    <!-- 工具导入 --> 
    <jsp:include page="XiaoShouChaXun_detail.jsp"></jsp:include>
    <jsp:include page="XiaoShouChaXun_edit.jsp"></jsp:include>
