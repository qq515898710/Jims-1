   ...
   <div class="modal-dialog"> 
    <div class="modal-content"> 
     <div class="modal-header"> 
      ...
      <h6 class="modal-title" id="myModalLabel"> <i class="icon-edit align-top bigger-125"></i>&nbsp;修改退货单信息 </h6> 
     </div> 
     <!--.modal-header  --> 
	            ...
	            success: function(data) {
		            if(data.success){
			            $("#edit-alert").html('<div class="alert alert-block alert-success">'+
			                    ...
			                    '<div class="success bold-center">修改成功,'+'<a href="coop/rukutuihuochaxun.html" class="green">'+
			                    '<span id="mysecond" class="green">'+5+
			                    '</span>秒自动跳转</a><div></div>');
		            	 countDown(5, "coop/rukutuihuochaxun.html");
			        }else{
