...
-- ----------------------------
INSERT INTO `tb_good_info` VALUES ('g1', '杜蕾斯避孕套', '避孕套', '未知', '未知', '盒子', '这是什么?', '无', '可以采购,质量非常不错', '2014-11-18 19:25:32');
INSERT INTO `tb_good_info` VALUES ('g14169274263950000', '三星手机', '手机', '韩国', '部', '盒子', '111', '222', '没有', '2014-11-25 22:57:06');
INSERT INTO `tb_good_info` VALUES ('g14170739856190000', '120', '1201', '012', '0120', '120', '1201', '201', '20102', '2014-11-27 15:39:45');
...
-- ----------------------------
INSERT INTO `tb_inventory_info` VALUES ('1', 'g1', '35', '990', '2014-11-27 21:22:53');
...
CREATE TABLE `tb_provider_good` (
  ...
  CONSTRAINT `tb_provider_good_ibfk_1` FOREIGN KEY (`provider_id`) REFERENCES `tb_provider_info` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `tb_provider_good_ibfk_2` FOREIGN KEY (`good_id`) REFERENCES `tb_good_info` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of tb_provider_good
-- ----------------------------
INSERT INTO `tb_provider_good` VALUES ('p1', 'g1');
INSERT INTO `tb_provider_good` VALUES ('p14167281494420000', 'g14169274263950000');
INSERT INTO `tb_provider_good` VALUES ('p14167281494420000', 'g14170739856190000');
...
-- ----------------------------
INSERT INTO `tb_provider_info` VALUES ('p1', 'c', '莫梓奇', '广东东莞', '', null, null, null, null, null, null, null);
...
-- Records of tb_stock
-- ----------------------------
INSERT INTO `tb_stock` VALUES ('stock1', 'p1', 'moziqi', 'g1', '35', '100', '3500', '22', '2014-11-09 21:28:06', '2121', '毛泽东', '');
INSERT INTO `tb_stock` VALUES ('stock14170925260710000', 'p14167281494420000', 'moziqi', 'g14170739856190000', '1010', '10', '10100', '10', '2014-11-27 20:48:46', '10', '10', '1');
INSERT INTO `tb_stock` VALUES ('stock14170925260710001', 'p14167281494420000', 'moziqi', 'g14169274263950000', '101', '1011', '102111', '10', '2014-11-27 20:48:46', '10', '10', '1');
INSERT INTO `tb_stock` VALUES ('stock14171586359390000', 'p14167281494420000', 'moziqi', 'g14170739856190000', '10', '10', '100', '10', '2014-11-28 15:10:35', '10', '10', '1');
...
CREATE TRIGGER `trigger_insert_tb_inventory_after` AFTER INSERT ON `tb_good_info` FOR EACH ROW     begin
     insert into tb_inventory_info(good_id) value(new.id);
   end
;;
DELIMITER ;
